...
<nav class="navbar navbar-inverse">
	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.jsp">uGive</a>
		</div>
		<div class="collapse navbar-collapse" id="myNavbar">
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a data-toggle="dropdown"
					href="helpful_links.jsp">Other Links<b class="caret"></b></a> <!-- this page can be changed to whatever we want -->
				...
				<li><a href="contact.jsp">Contact</a></li> <!-- this page can be changed to whatever we want -->
			</ul>
