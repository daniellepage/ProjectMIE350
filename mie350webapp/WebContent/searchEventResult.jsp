		...
		<div class="row content">
			...
			<div class="col-sm-8 text-left">
				...
				<br /> <br /> The following <B><c:out
						value="${events.size()}" /> events</B> match your search criteria: <br>
						...
						<c:forEach items="${events}" var="event">
							<tr>
								...
								<td align="center"><a class="btn btn-warning"
									href="TaggedEventsController?action=setInterestedEvent&eventID=<c:out value="${event.getEventID()}"/>">Interested</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
