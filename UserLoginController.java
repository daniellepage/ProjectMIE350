...
public class UserLoginController extends HttpServlet {
	...
	private TaggedEventsDao dao;
	
	public UserLoginController() {
		super();
		dao = new TaggedEventsDao();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (user.isValid()) {
				...
				if(!user.getActive()) {
					response.sendRedirect("deactivatedAccount.jsp");
				}
				 ...
				 */
				HashMap<Integer, String> taggedEvents = new HashMap<Integer, String>();
				taggedEvents = dao.getEventTags(user.getUsername());
				session.setAttribute("taggedEvents", taggedEvents);
